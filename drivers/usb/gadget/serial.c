...
*/
#define GS_VENDOR_ID			0x12d1	/* NetChip */
#define GS_PRODUCT_ID			0x1c05	/* Linux-USB Serial Gadget */
#define GS_CDC_PRODUCT_ID		0x1c05	/* ... as CDC-ACM */
