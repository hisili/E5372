 ...
 *
 * $Id: wlm.h,v 1.12.6.2 2010-12-15 05:18:05 $
 */
...
#define WLM_VERSION_STR "wlm version: 10.04.0 (support 4330, 4334, 43236 and more)"
...
/* Returns Receive Signal Strength Indicator (RSSI) from CW tone.
 *
 * param[in] rssi RSSI returned.
 *
 * return - True for success, false for failure.
 ...
 *
 * vardata[out] nvram variable content or value -A user supplied buffer.
 * varname[in] name of the nvram variable .
 *
 * return - True for success, false for failure.
 */
WLM_FUNCTION
