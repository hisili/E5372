 ...
 *
 * $Id: linux_osl.h 275703 2011-08-04 20:20:27Z $
 */
...
/*l00186593  2011-11-22 begin*/
#define	printf(fmt, args...)	printk("[WIFI]"fmt, ## args) //printk(fmt , ## args)
/*	
#include <drivers/mmc/host/wifi_printf.h>	
#define	printf(fmt, args...)	 	  DEBUG_FUNC_WIFI_MODULE(WIFI_PRINT,WIFI_DEBUG_INFO,fmt, ## args) 
*/
/*l00186593  2011-11-22 end*/
