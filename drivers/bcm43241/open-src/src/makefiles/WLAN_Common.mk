...
define wlan_copy_to_gen
  $(if $(WLAN_COPY_GEN),&& mkdir -pv $(subst $(abspath $2),$(abspath $2/$(WLAN_GenDir)),$(dir $1)) && \
    cp -pv $1 $(subst $(abspath $2),$(abspath $2/$(WLAN_GenDir)),$(dir $1)))
endef
define wlan_copy_from_gen
$1: $(subst $(abspath $2),$(abspath $2/$(WLAN_GenDir)),$1) ; cp -pv $$< $$@
endef
...
ifneq (,$(wildcard $(addsuffix /wl/clm/private/wlc_clm_data.xml,$2 $2/../../src $2/../../../src)))
  ...
  $$(call wlan_copy_from_gen,$1/wlc_clm_data$4.c,$2)
endif
