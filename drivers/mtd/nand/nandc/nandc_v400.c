...
struct nandc_reg_desc nandc4_reg_desc_table_v400[] =
{
    ...
    {
        NANDC4_REG_CMD_OFFSET,
        0,
        nandc4_cont_cmd
    },

    {
        NANDC4_REG_ADDRL_OFFSET,
        0,
        nandc4_cont_addrl
    },

    {
        NANDC4_REG_ADDRH_OFFSET,
        0,
        nandc4_cont_addrh
    },

    {
        NANDC4_REG_DATA_NUM_OFFSET,
        0,
        nandc4_cont_datanum
    },

    {
        NANDC4_REG_OP_OFFSET,
        0,
        nandc4_cont_op
    },
    ...
    {
        NANDC4_REG_STATUS_OFFSET,
        0,
        nandc4_cont_opstatus
    },

    {
        NANDC4_REG_INTEN_OFFSET,
        0,
        nandc4_cont_inten
    },

    {
        NANDC4_REG_INTS_OFFSET,
        0,
        nandc4_cont_intstatus
    },

    {
        NANDC4_REG_INTCLR_OFFSET,
        0,
        nandc4_cont_intclr
    },

    {
        NANDC4_REG_ECC_PARA_OFFSET,
        0,
        nandc4_cont_eccselect
    },

    {
        NANDC4_REG_SEGMENT_ID,
        0,
...
u32 nandc4_ctrl_init(struct nandc_bit_cmd  *  bitcmd, struct nandc_host *host)
{
 ...
 /*--by monan cs*/
    ...
    /*GPIO_6_0: nand write protect disable,(actually, this should be done early in GPIO module's initialize)*/
    *(volatile int *)0x90017000  = 0x1;
    *(volatile int *)0x90017004  = 0x1;
    #endif
#endif
...
struct nandc_ecc_info nandc4_eccinfo[] =
{
    ...
    {nandc_size_4k,     256,    nandc4_ecc_4smb,        &nandc4_oob48_ecc4  },
