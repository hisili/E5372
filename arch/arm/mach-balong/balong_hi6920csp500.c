...
static struct map_desc pv500v1_io_desc[] __initdata = {
    ...
    /*TTF memory,20MB*/
    {
        .virtual    = ECS_TTF_MEM_BASE - ECS_MDDR_RESERVE_ADDR + GLOBAL_MEM_GU_RESERVED_ADDR_VIRT,
    ...
    /*DICC,128KB*/
    {
        .virtual    = ECS_TTF_DICC_BASE - ECS_MDDR_RESERVE_ADDR + GLOBAL_MEM_GU_RESERVED_ADDR_VIRT,
