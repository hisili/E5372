...
static struct usb_interface_descriptor ecm_control_intf1 = {
	.bLength =		sizeof ecm_control_intf1,
	.bDescriptorType =	USB_DT_INTERFACE,
...
static struct usb_descriptor_header *ecm_fs_function[] = {
	...
	(struct usb_descriptor_header *) &ecm_control_intf1,
	(struct usb_descriptor_header *) &ecm_header_desc,
	(struct usb_descriptor_header *) &ecm_union_desc,
	(struct usb_descriptor_header *) &ecm_desc,
	/* NOTE: status endpoint might need to be removed */
...
ecm_bind(struct usb_configuration *c, struct usb_function *f)
{
	...
	ecm_control_intf1.bInterfaceNumber = status;
...
ecm_bind_config(struct usb_configuration *c, u8 ethaddr[ETH_ALEN])
{
	...
	if (ecm_string_defs[0].id == 0) {
		...
		ecm_control_intf1.iInterface = status;
