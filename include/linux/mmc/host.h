...
struct balong_sdio_host{	
	...
	u8                      config;	
	unsigned int                     irq;
	struct tasklet_struct   detect_tasklet;
	unsigned int  fifoWidth;
	unsigned int  fifoDepth;
	char *	     buf;
	unsigned int  buf_len;
	unsigned int  buf_dma_len;
};
...
#ifdef USING_TTF_SKB
	SK_BUFF_PRIVATE_STRU private_mem; 
#endif
}*BCMDATA;
#endif
...
#define MMC_TIMING_SD_HS	2
    ...
    unsigned char cclk_low_power;    /*low power control*/    /*syb*/
#define MMC_CCLK_LOW_POWER_MODE 1
#define MMC_CCLK_NO_LOW_POWER_MODE 0 
