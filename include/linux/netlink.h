...
#define NETLINK_DEVICE_EVENT	20

#define NETLINK_USER_WIFI_EVENT	 21
...
typedef enum _DEVICE_ID
{
    ...
    DEVICE_ID_TIMER = 15, //special timer device
	DEVICE_ID_MAX
} DEVICE_ID;
...
typedef enum _USB_EVENT
{
	...
	USB_SUSPEND,
	USB_RESUME,	
    USB_AF10_ATTACH,            /*AF10在位*/
    USB_AF10_REMOVE,            /*AF10不在位*/
    USB_AF10_DEVICE_ATTATCH,
    USB_AF10_DEVICE_REMOVE,
	USB_EVENT_MAX
} USB_EVENT;
...
typedef enum _BAT_EVENT
{
    ...
    BAT_EXTCHARGING_ON_START,/*开机模式下，开始对外充电*/
    BAT_EXTCHARGING_ON_STOP,/*开机模式下，停止对外充电*/
    BAT_EXTCHARGING_TEMP_STOP,/*对外充电进入温保护状态*/
    BAT_CHARGING_PERCENT = 8,  /*电池电量百分比发生变化*/
