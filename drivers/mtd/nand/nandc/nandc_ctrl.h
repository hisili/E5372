...
#if (FEATURE_EPAD == FEATURE_ON)
    char devid[NANDC_READID_SIZE];/*modified by zkf52403*/
#endif
...
struct nandc_host 
{
    ...
    u32 column;
    u32 offset;
    /*if nand page size large than 2k ,use temp buffer here*/
    u32 IsUseBuffer;        
    dma_addr_t  dma_addr;
#endif
};
...
*/
struct nandc_init_info        /* nandc2_init_info,nandc3_init_info,nandc4_init_info*/
{
