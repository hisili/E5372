#ifndef __ASM_ARCH_BALONG_V3R2_CS_H
#define __ASM_ARCH_BALONG_V3R2_CS_H
...
#define TIMER_STAMP_ADDR	0x90026000
#endif

/*串口*/
#define PV500V1_UART0_BASE      0x90020000  /* UART 0 */
#define PV500V1_UART1_BASE      0x90021000  /* UART 1 */
#define PV500V1_UART2_BASE      0x90022000  /* UART 2 */
#define PV500V1_UART_REGS_SIZE  SZ_4K

#define VIRT_PV500V1_UART0_BASE      IO_ADDRESS(PV500V1_UART0_BASE)  /* UART 0 */
...
/*timer 8~15*/            
#define PV500V1_TIMER_BASE      0x90002000
#define TIMER_8                               8
#define TIMER_OFFSET(x)                 0x14*((x)-TIMER_8)  

/*V3R2 CS f00164371，Timer大小为8K，不是4K*/
#define PV500V1_CLK_REGS_SIZE   SZ_8K

#define PV500V1_TIMER14_BASE     (PV500V1_TIMER_BASE + TIMER_OFFSET(14))
...
/*V3R2 CS f00164371，定义静态映射的地址，PS融合后会删除该部分内容*/
#define IPF_REG_BASE_ADDR             (0x900AC000) 
#define IPF_REG_SIZE                  (0x1000)


/*timer0~2*/
#define PBXA9_TIMER0_BASE            (0x90026000)
#define PBXA9_TIMER0_SIZE			SZ_4K
#define PBXA9_TIMER0_VA_BASE      IO_ADDRESS(PBXA9_TIMER0_BASE)  

/*WDT*/
#define PBXA9_WDT_BASE               0x9000D000
