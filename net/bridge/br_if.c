...
static struct net_device *new_bridge_dev(struct net *net, const char *name)
{
	...
	br->bridge_forward_delay = br->forward_delay = 4 * HZ; /* fuxiaowei - change the 15s delay to 4s. because we don't have security 
																		module, we can't execute brctl setfd br0 4. So we set it here.*/
