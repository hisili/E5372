...
then
    ...
    insmod /system/bin/wifi_brcm/driver/bcm43362.ko firmware_path=/system/bin/wifi_brcm/firmware/firmware_apsta.bin nvram_path=/system/bin/wifi_brcm/nv/nv.txt
