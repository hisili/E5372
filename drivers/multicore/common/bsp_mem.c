...
/**************************************************************************
  宏定义
**************************************************************************/
//#ifndef __BSP_DEBUG__
/*Info 760: (Info -- Redundant macro '__BSP_MEM_DEBUG__' defined identically at line 23)*/
...
BSP_U32 sg_AllocListSize[] =       {32,   128,   512,  1024,  1536,  2048,  4096, 8192, 10240};
BSP_U32 sg_AllocMinNum[] =        {512,   256,   100,      10,    1,   2,     2,    1,     1};
BSP_U32 sg_AllocMaxNum[] =       {1024, 1024,  1024,  1024,  2048,  100  , 80, 40,     2};
#else
BSP_U32 sg_AllocListSize[] =      {32,     128,   512,  1024,  1536,  2048,  4096, 8192, 32*1024, 64*1024};
BSP_U32 sg_AllocMinNum[] =        {512,   256,   100,     10,    1,      2,   10,   10,   1,      1};
BSP_U32 sg_AllocMaxNum[] =       {1024,  1024,   1024,  1024,  2048,  100 ,   80,   40,  10,      4};
#endif
#else
BSP_U32 sg_AllocListSize[] =        {32, 128, 512, 1024, 2048, 4096, 8192, 0x4000, 0x8000, 0x10000};
#endif
...
/* SpinLock Addr */
#define MEM_SPIN_ADDR       MEMORY_RAM_CORESHARE_MEM_ADDR

#define MEM_CTX_RESERVED 4
BSP_U32* sg_pAllocSizeTbl = (BSP_U32*)(MEM_CTX_ADDR + MEM_CTX_RESERVED);
MEM_ALLOC_INFO* sg_pIccAllocInfo = (MEM_ALLOC_INFO*)(MEM_CTX_ADDR + sizeof(sg_AllocListSize) + MEM_CTX_RESERVED);
...
#define MEM_GET_ALLOC_ADDR(x)       ((VOID*)((BSP_U32)(x)-MEM_NODE_MGR_SIZE))
#define MEM_OFFSET_OF(type, member) ((BSP_U32) (&((type *)0)->member))
#define MEM_ITEM_NEXT(x)            (*(BSP_U32*)(((BSP_U32)(x)-MEM_NODE_MGR_SIZE+MEM_OFFSET_OF(MEM_MGR_INFO, u32Next))))
#define MEM_ITEM_SIZE(x)            (*(BSP_U32*)(((BSP_U32)(x)-MEM_NODE_MGR_SIZE+MEM_OFFSET_OF(MEM_MGR_INFO, u32Size))))
#define MEM_ITEM_FLAGS(x)           (*(BSP_U32*)(((BSP_U32)(x)-MEM_NODE_MGR_SIZE+MEM_OFFSET_OF(MEM_MGR_INFO, u32Flags))))
#define MEM_ITEM_MAGIC(x)           (*(BSP_U32*)(((BSP_U32)(x)-MEM_NODE_MGR_SIZE+MEM_OFFSET_OF(MEM_MGR_INFO, u32MagicNumber))))
#define MEM_ITEM_FILE_NAME(x)       (*(BSP_U32*)(((BSP_U32)(x)-MEM_NODE_MGR_SIZE+MEM_OFFSET_OF(MEM_MGR_INFO, u32FileName))))
#define MEM_ITEM_LINE(x)            (*(BSP_U32*)(((BSP_U32)(x)-MEM_NODE_MGR_SIZE+MEM_OFFSET_OF(MEM_MGR_INFO, u32Line))))
#define MEM_ITEM_STATUS(x)          (*(BSP_U32*)(((BSP_U32)(x)-MEM_NODE_MGR_SIZE+MEM_OFFSET_OF(MEM_MGR_INFO, u32Status))))
#define MEM_IS_AXI_ADDR(ptr) \
((BSP_U32)(ptr) >= AXI_MEM_ADDR && (BSP_U32)(ptr) < AXI_MEM_ADDR+AXI_MEM_SIZE)
...
#define MEM_LOCAL_UNLOCK() local_irq_enable()

#define MEM_SPIN_INIT() memset((VOID*)MEM_SPIN_ADDR, 0, sizeof(BSP_U32))
    ...
    do{\
        MEM_LOCAL_LOCK();\
        spinLockAmpTake((BSP_U32*)MEM_SPIN_ADDR);\
    }while(0)
...
#elif (defined(CHIP_BB_6920ES) || defined (CHIP_BB_6920CS)) /*6920通用*/
#define MEM_SPIN_LOCK() \
do{\
    MEM_LOCAL_LOCK();\
    spinLockAmpTake((BSP_U32*)MEM_SPIN_ADDR);\
...
do{\
    ...
    #define MEM_SPIN_UNLOCK() \
    do{\
    spinLockAmpGive((BSP_U32*)MEM_SPIN_ADDR);\
    MEM_LOCAL_UNLOCK();\
    }while(0)
#elif defined (BOARD_ASIC_BIGPACK) && defined (VERSION_V3R2)
    /*V3R2 CS f00164371*/
...
LOCAL BSP_S32 memInitPool(BSP_U32 u32PoolType)
{
    ...
    case MEM_NORM_DDR_POOL:
        {
            ...
            pAllocInfo->memPoolInfo.u32BaseAddr = (BSP_U32)MEM_NORM_DDR_POOL_BASE_ADDR;
    ...
    case MEM_ICC_DDR_POOL:
        {
            pAllocInfo->memPoolInfo.u32CurPosAddr =
            pAllocInfo->memPoolInfo.u32BaseAddr = (BSP_U32)DDR_VIRT_TO_PHY(MEM_ICC_DDR_POOL_BASE_ADDR);/*lint !e778*/
            pAllocInfo->memPoolInfo.u32Left = 
    ...
    case MEM_ICC_AXI_POOL:
        {
            pAllocInfo->memPoolInfo.u32CurPosAddr =
            pAllocInfo->memPoolInfo.u32BaseAddr = (BSP_U32)DRV_AXI_VIRT_TO_PHY(MEM_ICC_AXI_POOL_BASE_ADDR);
            pAllocInfo->memPoolInfo.u32Left = 
...
LOCAL INLINE BSP_BOOL memPtrInvalid(VOID* pMem)
{
    ...
    for (u32Type = MEM_NORM_DDR_POOL; u32Type < MEM_POOL_MAX; u32Type++)
    {
        ...
        if ((BSP_U32)pMem >= pPoolInfo->u32BaseAddr || 
            (BSP_U32)pMem < pPoolInfo->u32BaseAddr + pPoolInfo->u32Size)
        {
            u32FindMem = 1;
        }
    }
    if (!u32FindMem ||
        ...
        MEM_ITEM_FLAGS(pMem) >= (BSP_U32)MEM_POOL_MAX)
    {
        return TRUE;
    }
    return FALSE;
...
{
   BSP_U32 u32RetAddr = 0;

   if (pAllocInfo->memPoolInfo.u32Left < u32Size)
   {
#if (defined(CHIP_BB_6920ES) || defined (CHIP_BB_6920CS))
#else
        printk("cannot alloc from pool, need size:%d, left:%d, total size:%d line:%d\n", 
                  u32Size, pAllocInfo->memPoolInfo.u32Left, pAllocInfo->memPoolInfo.u32Size, __LINE__);
#endif
        return NULL;
   }
...
INLINE VOID memFree(BSP_U32 u32PoolType, BSP_VOID* pMem, BSP_U32 u32Size)
{
    ...
    if (MEM_ICC_AXI_POOL == u32PoolType)
    {
        ...
        pAllocInfo->allocList[cnt] = DRV_AXI_VIRT_TO_PHY(pMem);
    }
    else if (MEM_ICC_DDR_POOL == u32PoolType)
    {
        MEM_ITEM_NEXT(pMem) = (BSP_U32)(pAllocInfo->allocList[cnt]);
        pAllocInfo->allocList[cnt] = DDR_VIRT_TO_PHY(pMem);/*lint !e64*/
    }
...
int memUsrInitFunction(void)
{
	...
	memset((VOID*)ECS_NV_BASE_ADDR_VIRT, 0, 16);
    memset((VOID*)MEMORY_AXI_ICC_ADDR, 0, MEMORY_AXI_ICC_SIZE);
    return 0;
}
...
BSP_S32 BSP_MEM_Init(VOID)
{
    ...
    ret = BSP_SYNC_Lock(SYNC_MODULE_MEM, &state, 10000);
    if(ret)
    {
    ...
    if(0 == state)
    {
        ...
        memset((VOID*)sg_pIccAllocInfo, 0, (sizeof(MEM_ALLOC_INFO)*(MEM_POOL_MAX)));
    ...
    state = 1;
    (BSP_VOID)BSP_SYNC_UnLock(SYNC_MODULE_MEM, state);
...
#ifdef __BSP_MEM_DEBUG__
    if ((BSP_U32)enFlags >= MEM_POOL_MAX)
    {
...
BSP_S32 BSP_MEM_DumpAllocList(BSP_U32 u32Size, BSP_U32 u32PoolType)
{
    ...
    pCurAddr = (VOID*)PHY_TO_VIRT(pAllocInfo->allocList[u32Item]);
