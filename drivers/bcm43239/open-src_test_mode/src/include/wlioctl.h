...
typedef struct n2x2 {
	uint8 siso[WL_NUM_RATES_MCS_1STREAM];       
	uint8 cdd[WL_NUM_RATES_MCS_1STREAM];        
	uint8 stbc[WL_NUM_RATES_MCS_1STREAM];       
	uint8 sdm[WL_NUM_RATES_MCS_1STREAM];        
} n2x2_t;

typedef struct n3x3 {
	uint8 s1x1[WL_NUM_RATES_MCS_1STREAM];       
	uint8 s1x2[WL_NUM_RATES_MCS_1STREAM];       
	uint8 s2x2[WL_NUM_RATES_MCS_1STREAM];       
	uint8 s3x3[WL_NUM_RATES_MCS_1STREAM];       
} n3x3_t;

typedef struct n3x3a {
	uint8 u20s1x3[WL_NUM_RATES_MCS_1STREAM];    
	uint8 u20s2x3[WL_NUM_RATES_MCS_1STREAM];    
	uint8 u40s1x3[WL_NUM_RATES_MCS_1STREAM];    
	uint8 u40s2x3[WL_NUM_RATES_MCS_1STREAM];    
	uint8 ul20s1x3[WL_NUM_RATES_MCS_1STREAM];   
	uint8 ul20s2x3[WL_NUM_RATES_MCS_1STREAM];   
} n3x3a_t;
...
typedef struct txpwr_limits {
	...
	uint8 cck[WL_NUM_RATES_CCK];        
	uint8 ofdm[WL_NUM_RATES_OFDM];      
	uint8 ofdm_cdd[WL_NUM_RATES_OFDM];  
	union {
		struct n2x2 n;          
		struct n3x3 ht;         
	} u20;
	
	uint8 ofdm_40[WL_NUM_RATES_OFDM];   
	uint8 ofdm_40_cdd[WL_NUM_RATES_OFDM];   
	union {
		struct n2x2 n;
		struct n3x3 ht;
	} u40;
	...
	uint8 cck_20ul[WL_NUM_RATES_CCK];   
	uint8 ofdm_20ul[WL_NUM_RATES_OFDM]; 
	uint8 ofdm_20ul_cdd[WL_NUM_RATES_OFDM]; 
	n3x3_t ht20ul;              
	n3x3a_t ht;             
} txpwr_limits_t;


#define WL_TX_POWER_CCK_FIRST       OFFSETOF(txppr_t, cck)      
#define WL_TX_POWER_OFDM20_FIRST    OFFSETOF(txppr_t, ofdm)     
#define WL_TX_POWER_OFDM20_CDD_FIRST    OFFSETOF(txppr_t, ofdm_cdd) 
#define WL_TX_POWER_MCS20_SISO_FIRST    OFFSETOF(txppr_t, u20.n.siso)   
#define WL_TX_POWER_MCS20_CDD_FIRST OFFSETOF(txppr_t, u20.n.cdd)    
#define WL_TX_POWER_MCS20_STBC_FIRST    OFFSETOF(txppr_t, u20.n.stbc)   
#define WL_TX_POWER_MCS20_SDM_FIRST OFFSETOF(txppr_t, u20.n.sdm)    

#define WL_TX_POWER_20_S1x1_FIRST   OFFSETOF(txppr_t, u20.ht.s1x1)  
#define WL_TX_POWER_20_S1x2_FIRST   OFFSETOF(txppr_t, u20.ht.s1x2)  
#define WL_TX_POWER_20_S1x3_FIRST   OFFSETOF(txppr_t, ht.u20s1x3)   
#define WL_TX_POWER_20_S2x2_FIRST   OFFSETOF(txppr_t, u20.ht.s2x2)  
#define WL_TX_POWER_20_S2x3_FIRST   OFFSETOF(txppr_t, ht.u20s2x3)   
#define WL_TX_POWER_20_S3x3_FIRST   OFFSETOF(txppr_t, u20.ht.s3x3)  


#define WL_TX_POWER_OFDM40_FIRST    OFFSETOF(txppr_t, ofdm_40)  
#define WL_TX_POWER_OFDM40_CDD_FIRST    OFFSETOF(txppr_t, ofdm_40_cdd)  
#define WL_TX_POWER_MCS40_SISO_FIRST    OFFSETOF(txppr_t, u40.n.siso)   
#define WL_TX_POWER_MCS40_CDD_FIRST     OFFSETOF(txppr_t, u40.n.cdd)    
#define WL_TX_POWER_MCS40_STBC_FIRST    OFFSETOF(txppr_t, u40.n.stbc)   
#define WL_TX_POWER_MCS40_SDM_FIRST     OFFSETOF(txppr_t, u40.n.sdm)    

#define WL_TX_POWER_40_S1x1_FIRST   OFFSETOF(txppr_t, u40.ht.s1x1)  
#define WL_TX_POWER_40_S1x2_FIRST   OFFSETOF(txppr_t, u40.ht.s1x2)  
#define WL_TX_POWER_40_S1x3_FIRST   OFFSETOF(txppr_t, ht.u40s1x3)   
#define WL_TX_POWER_40_S2x2_FIRST   OFFSETOF(txppr_t, u40.ht.s2x2)  
#define WL_TX_POWER_40_S2x3_FIRST   OFFSETOF(txppr_t, ht.u40s2x3)   
#define WL_TX_POWER_40_S3x3_FIRST   OFFSETOF(txppr_t, u40.ht.s3x3)  
...
#define WL_TX_POWER_20UL_S1x1_FIRST OFFSETOF(txppr_t, ht20ul.s1x1) 
#define WL_TX_POWER_20UL_S1x2_FIRST OFFSETOF(txppr_t, ht20ul.s1x2) 
#define WL_TX_POWER_20UL_S1x3_FIRST OFFSETOF(txppr_t, ht.ul20s1x3) 
#define WL_TX_POWER_20UL_S2x2_FIRST OFFSETOF(txppr_t, ht20ul.s2x2) 
#define WL_TX_POWER_20UL_S2x3_FIRST OFFSETOF(txppr_t, ht.ul20s2x3) 
#define WL_TX_POWER_20UL_S3x3_FIRST OFFSETOF(txppr_t, ht20ul.s3x3) 
