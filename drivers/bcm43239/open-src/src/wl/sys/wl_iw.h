...
typedef enum
{
	STA_DISCONNECT_REASON_CODE_AUTH_WEP_NO_MATCH = 13,
	STA_DISCONNECT_REASON_CODE_AUTH_FAILED = 15
}STA_DISCONNECT_REASON_CODE;
#endif
...
#define WL_KEEP_ALIVE		(SIOCIWFIRSTPRIV+33)
